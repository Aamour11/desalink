...
--
-- Memasukkan data awal untuk tabel `users`
--
INSERT INTO `users` (`id`, `name`, `email`, `role`, `rtRw`, `avatarUrl`) VALUES
('user-1', 'Admin Desa', 'admin@desa.com', 'Admin Desa', '-', 'https://placehold.co/100x100.png'),
('user-2', 'Budi Santoso', 'budi.s@desa.com', 'Petugas RT/RW', '001/001', 'https://placehold.co/100x100.png'),
('user-3', 'Siti Aminah', 'siti.a@desa.com', 'Petugas RT/RW', '002/001', 'https://placehold.co/100x100.png'),
('user-4', 'Agus Wijaya', 'agus.w@desa.com', 'Petugas RT/RW', '003/002', 'https://placehold.co/100x100.png');
...
--
-- Memasukkan data awal untuk tabel `umkm`
--
...
('umkm-6', 'Sate Ayam Madura Cak Mamat', 'Mamat Alkatiri', '6789012345678', 'Kuliner', 'Jl. Kuliner No. 12', '003/02', '081234567891', 'aktif', '2021-08-17', 4, 'Sate ayam dengan bumbu kacang khas Madura yang legendaris.', 'https://placehold.co/600x400.png');
